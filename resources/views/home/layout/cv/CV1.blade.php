	...
	<div class="row">
		<div class="left col-md-4">
			<div class="left1 backgroundColor">
				<div class="steven"><input name="name"  type="text" placeholder="Your Name" value="{{ Auth::user()->name }}" ></div>
				<div class="">
				...
				<div class="graphic">	<input name="job-name" type="text" id="jobName" placeholder="Wanted job"><br>
					<input name="salary" type="number" placeholder="Salary" max="100000000"></div>
				<div class="icon">
					<span></span>
					<span></span>
					<span></span>
			...
			<div class="left2">
				...
				<div class="icon1 icon_left2">
					...
					<span class="text_layer"><input name="address" placeholder="Your Address" value="{{ Auth::user()->address }}">
                  </span>
				</div>
				<div class="icon2 icon_left2">
					...
					<span class="sdt" ><input name="phone" placeholder="Your Phone Number" value="{{ Auth::user()->phone }}"></span><br>
		...
		<div class="right col-md-8">
					...
					<script type="text/javascript" >
						function addEx() {
							...
							x.append('<div id="ex-tag'+dem+'">'
									+'<hr>'
									+'<div class="wordpress">'
									+'<span class="list"><input name="ex_name1" type="text" placeholder="Name Company"></span>'
									+'<span class="nam"><input name="ex_time1" type="text" class="color" placeholder="Time"></span><br>'
									+'<input name="ex_position1" type="text" placeholder="Position">'
									+'</div>'
									+'<div class="content">'
									+'<p class="text_max"><input name="ex_achiment1"  type="text" placeholder="Achiment"></p>'
									+'<textarea name="ex_describe1"  placeholder="Describe" cols="50"></textarea><br>'
			...
			<div class="right3">
				...
				<textarea name="hobbies" cols="90" rows="5"  class="ckeditor" placeholder="Yours hobbies"></textarea>
